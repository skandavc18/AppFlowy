...
class CollectionPlugin extends Plugin {
  CollectionPlugin({required ViewPB view})
  ...
  @override
  PluginWidgetBuilder get widgetBuilder => CollectionPluginWidgetBuilder(
        notifier: notifier,
...
class CollectionPluginWidgetBuilder extends PluginWidgetBuilder
    with NavigationItem {
  CollectionPluginWidgetBuilder({
  ...
  String? get viewName {
    ...
    return kind == null
        ? 'Untitled collection'
        : CollectionRegistry.typeFor(kind).defaultName;
  }
