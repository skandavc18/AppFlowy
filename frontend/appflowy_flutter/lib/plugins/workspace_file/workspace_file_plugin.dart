...
/// Opens a workspace file full window instead of inside a document page.
class WorkspaceFilePlugin extends Plugin {
  WorkspaceFilePlugin({required ViewPB view})
  ...
  @override
  PluginWidgetBuilder get widgetBuilder => WorkspaceFilePluginWidgetBuilder(
        notifier: notifier,
...
class WorkspaceFilePluginWidgetBuilder extends PluginWidgetBuilder
    with NavigationItem {
  WorkspaceFilePluginWidgetBuilder({
  ...
  @override
  String? get viewName => view.name.isEmpty ? 'Untitled file' : view.name;
